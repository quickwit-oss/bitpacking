...
unsafe fn avxpackblock(input_ptr: *const __m256i, compressed: *mut __m256i, num_bits: u8) { 
    match num_bits {
		0 => avxpackblock0(input_ptr, compressed),
		1 => avxpackblock1(input_ptr, compressed),
		2 => avxpackblock2(input_ptr, compressed),
		3 => avxpackblock3(input_ptr, compressed),
		4 => avxpackblock4(input_ptr, compressed),
		5 => avxpackblock5(input_ptr, compressed),
		6 => avxpackblock6(input_ptr, compressed),
		7 => avxpackblock7(input_ptr, compressed),
		8 => avxpackblock8(input_ptr, compressed),
		9 => avxpackblock9(input_ptr, compressed),
		10 => avxpackblock10(input_ptr, compressed),
		11 => avxpackblock11(input_ptr, compressed),
		12 => avxpackblock12(input_ptr, compressed),
		13 => avxpackblock13(input_ptr, compressed),
		14 => avxpackblock14(input_ptr, compressed),
		15 => avxpackblock15(input_ptr, compressed),
		16 => avxpackblock16(input_ptr, compressed),
		17 => avxpackblock17(input_ptr, compressed),
		18 => avxpackblock18(input_ptr, compressed),
		19 => avxpackblock19(input_ptr, compressed),
		20 => avxpackblock20(input_ptr, compressed),
		21 => avxpackblock21(input_ptr, compressed),
		22 => avxpackblock22(input_ptr, compressed),
		23 => avxpackblock23(input_ptr, compressed),
		24 => avxpackblock24(input_ptr, compressed),
		25 => avxpackblock25(input_ptr, compressed),
		26 => avxpackblock26(input_ptr, compressed),
		27 => avxpackblock27(input_ptr, compressed),
		28 => avxpackblock28(input_ptr, compressed),
		29 => avxpackblock29(input_ptr, compressed),
		30 => avxpackblock30(input_ptr, compressed),
		31 => avxpackblock31(input_ptr, compressed),
		32 => avxpackblock32(input_ptr, compressed),
		_ => panic!("num_bits must be between [0..num_bits].")
	}
}
